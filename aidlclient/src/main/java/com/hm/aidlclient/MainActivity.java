...
public class MainActivity extends AppCompatActivity implements EasyPermissions.PermissionCallbacks {
    ...
    @OnClick({R.id.btn_baseknowledge, R.id.btn_bookmanager, R.id.btn_messenger, R.id.btn_provider, R.id.btn_binderpool, R.id.btn_inout})
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.btn_binderpool:
                ...
                break;
            case R.id.btn_inout:
                TestDataInOutActivity.launch(this);
                break;
            default:
                break;
        }
